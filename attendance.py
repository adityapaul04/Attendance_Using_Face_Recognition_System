...
class Attendance:
    def __init__(self, root):
        ...
        #FirstImage
        img1=Image.open(r"F:\Project\Face_Recognition_System\Images\attendance1.png")
        ...
        title_lbl=Label(bg_img,text="ATTENDANCE MANAGEMENT SYSTEM", font=("Times New Roman",35,"bold"),bg="red",fg="black")
        ...
        Left_frame.place(x=10,y=10,width=720, height=510)
        ...
        left_inside_frame.place(x=0,y=135,width=705,height=300)

        #Labels and Entry

        #Attendance id
        attendanceid_lbl = Label(left_inside_frame, text="Attendance ID:",font=("times new roman",12,"bold"))
        ...
        #Roll
        roll_lbl = Label(left_inside_frame, text="Roll:",font=("times new roman",12,"bold"))
        ...
        #Department
        deplbl = Label(left_inside_frame, text="Department:",font=("times new roman",12,"bold"))
        deplbl.grid(row=1, column=2, padx=10, pady=5, sticky=W)
        ...
        #Time
        time_lbl = Label(left_inside_frame, text="Time:",font=("times new roman",12,"bold"))
        ...
        #Date
        date_lbl = Label(left_inside_frame, text="Date:",font=("times new roman",12,"bold"))
        ...
        #Attendance
        attendance_lbl = Label(left_inside_frame, text="Attendance Status:",font=("times new roman",12,"bold"))
        ...
        btn_frame.place(x=0,y=250, width=690, height=35)
        ...
        Right_frame.place(x=760,y=10,width=740, height=510)

        table_frame=Frame(Right_frame,bd=2, relief=RIDGE, bg="white")
        table_frame.place(x=1,y=1,width=730,height=480)
